...
namespace Croupier {
	...
	public class SpinParser {
		...
		public static readonly Dictionary<string, string> MethodKeywords = new() {
			...
			{"zap", "Electrocution"},
			{"explosion", "Explosion"},
			{"explaccident", "Explosion"},
			{"exaccident", "Explosion"},
			{"expaccident", "Explosion"},
			{"explosiveaccident", "Explosion"},
			{"explosionaccident", "Explosion"},
			{"exacc", "Explosion"},
			{"expacc", "Explosion"},
			{"explacc", "Explosion"},
			{"explosionacc", "Explosion"},
			{"explosiveacc", "Explosion"},
