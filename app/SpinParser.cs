...
namespace Croupier {
	...
	public class SpinParser {
		...
		public static readonly Dictionary<string, string> MethodKeywords = new() {
			...
			{"antiquecurvedknife", "Antique Carved Knife"},
			{"antiquecurveknife", "Antique Carved Knife"},
			{"antiquecarvedknife", "Antique Carved Knife"},
			{"antiquecarveknife", "Antique Carved Knife"},
			{"antiqueknife", "Antique Carved Knife"},
			{"carvedknife", "Antique Carved Knife"},
			{"carveknife", "Antique Carved Knife"},
			{"curvedknife", "Antique Carved Knife"},
			{"curveknife", "Antique Carved Knife"},
			{"acknife", "Antique Carved Knife"},
