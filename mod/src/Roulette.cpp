...
std::unordered_map<eTargetID, std::string> Keyword::targetIDKeyMap = {
	{eTargetID::Unknown, ""},
	{eTargetID::KalvinRitter, "KR"},
	{eTargetID::JasperKnight, "JK"},
	{eTargetID::ViktorNovikov, "VN"},
	{eTargetID::DaliaMargolis, "DM"},
	{eTargetID::HarrySmokeyBagnato, "HSB"},
	{eTargetID::MarvSlickGonif, "MSG"},
	{eTargetID::SilvioCaruso, "SC"},
	{eTargetID::FrancescaDeSantis, "FDS"},
	{eTargetID::DinoBosco, "DB"},
	{eTargetID::MarcoAbiatti, "MA"},
	{eTargetID::CraigBlack, "CB"},
	{eTargetID::BrotherAkram, "BA"},
	{eTargetID::RezaZaydan, "RZ"},
	{eTargetID::ClausHugoStrandberg, "CHS"},
	{eTargetID::KongTuoKwang, "KTK"},
	{eTargetID::MatthieuMendola, "MM"},
	{eTargetID::JordanCross, "JC"},
	{eTargetID::KenMorgan, "KM"},
	{eTargetID::OybekNabazov, "ON"},
	{eTargetID::SisterYulduz, "SY"},
	{eTargetID::SeanRose, "SR"},
	{eTargetID::PenelopeGraves, "PG"},
	{eTargetID::EzraBerg, "EB"},
	{eTargetID::MayaParvati, "MP"},
	{eTargetID::ErichSoders, "ES"},
	{eTargetID::YukiYamazaki, "YY"},
	{eTargetID::OwenCage, "OC"},
	{eTargetID::KlausLiebleid, "KL"},
	{eTargetID::AlmaReynard, "AR"},
	{eTargetID::SierraKnox, "SK"},
	{eTargetID::RobertKnox, "RK"},
	{eTargetID::AjitKrish, "AJ"},
	{eTargetID::RicoDelgado, "RD"},
	{eTargetID::JorgeFranco, "JF"},
	{eTargetID::AndreaMartinez, "AM"},
	{eTargetID::BlairReddington, "BR"},
	{eTargetID::WazirKale, "WK"},
	{eTargetID::VanyaShah, "VS"},
	{eTargetID::DawoodRangan, "DR"},
	{eTargetID::BasilCarnaby, "BC"},
	{eTargetID::Janus, "J"},
	{eTargetID::NolanCassidy, "NC"},
	{eTargetID::GalenVholes, "GV"},
	{eTargetID::ZoeWashington, "ZW"},
	{eTargetID::SophiaWashington, "SW"},
	{eTargetID::AthenaSavalas, "AS"},
	{eTargetID::TysonWilliams, "TW"},
	{eTargetID::StevenBradley, "SB"},
	{eTargetID::LjudmilaVetrova, "LV"},
	{eTargetID::CarlIngram, "CI"},
	{eTargetID::MarcusStuyvesant, "MS"},
	{eTargetID::AlexaCarlisle, "AC"},
	{eTargetID::Agent1, "1"},
	{eTargetID::Agent2, "2"},
	{eTargetID::Agent3, "3"},
	{eTargetID::Agent4, "4"},
	{eTargetID::Agent5, "5"},
	{eTargetID::AgentMontgomery, "MON"},
	{eTargetID::AgentChamberlin, "CHA"},
	{eTargetID::AgentDavenport, "DAV"},
	{eTargetID::AgentLowenthal, "LOW"},
	{eTargetID::AgentThames, "THA"},
	{eTargetID::AgentTremaine, "TRE"},
	{eTargetID::AgentBanner, "BAN"},
	{eTargetID::AgentSwan, "SWA"},
	{eTargetID::AgentRhodes, "RHO"},
	{eTargetID::AgentGreen, "GRE"},
	{eTargetID::AgentPrice, "PRI"},
	{eTargetID::Hush, "H"},
	{eTargetID::ImogenRoyce, "IR"},
	{eTargetID::DonArchibaldYates, "DY"},
	{eTargetID::TamaraVidal, "TV"},
	{eTargetID::ArthurEdwards, "AE"},
	{eTargetID::NoelCrest, "NCR"},
	{eTargetID::SinhiAkkaVenthan, "SV"},
};
...
std::map<ZRepositoryID, eTargetID> targetsByRepoId = {
	{ZRepositoryID("3d25ee6c-61fa-4ba5-8f19-fedd905fd8fb"), eTargetID::KalvinRitter},
	{ZRepositoryID("579f2544-1970-4865-afa3-ad4566e5f98d"), eTargetID::JasperKnight},
	{ZRepositoryID("052434e7-f451-462f-a9d7-13657cb047c0"), eTargetID::ViktorNovikov},
	{ZRepositoryID("edad702b-5b37-4dc1-a47c-36a1588f1d3f"), eTargetID::DaliaMargolis},
	{ZRepositoryID("21017f2e-3090-4b41-91b9-1ec4ddd358f9"), eTargetID::HarrySmokeyBagnato},
	{ZRepositoryID("a713a8a2-e203-4032-9c4a-1f8eab4c3efa"), eTargetID::MarvSlickGonif},
	{ZRepositoryID("0dfaea51-3c36-4722-9eff-f1e7ef139878"), eTargetID::SilvioCaruso},
	{ZRepositoryID("94ab740b-b30f-4086-9aea-5c9c0de28456"), eTargetID::FrancescaDeSantis},
	{ZRepositoryID("d2c71b7c-8c85-479e-9c14-754f1b61f2e4"), eTargetID::DinoBosco}, // 9c81b545-a234-46c5-9296-54f9f2a0bb6d
	{ZRepositoryID("91071202-32b6-488f-aee7-09d8d847a6aa"), eTargetID::MarcoAbiatti},
	{ZRepositoryID("ab48a89d-e8a7-4df4-ae72-f0fccaa65e7f"), eTargetID::CraigBlack}, // 0b22a7cd-edd7-483d-8406-0a8706ae8047, ab48a89d-e8a7-4df4-ae72-f0fccaa65e7f, fb1ac120-0cea-4477-8344-8b4ffa5c3b01 (ET)
	{ZRepositoryID("07c64264-9fa9-4c4a-a933-802011bee9e6"), eTargetID::BrotherAkram},
	{ZRepositoryID("ca31c88f-d15e-407b-8407-231f1b068402"), eTargetID::RezaZaydan},
	{ZRepositoryID("b38b0b62-8071-4761-b2a5-2f635cd8da1b"), eTargetID::ClausHugoStrandberg},
	{ZRepositoryID("23415c1d-6ee8-41a8-9975-523f3eede581"), eTargetID::KongTuoKwang},
	{ZRepositoryID("4d0953f0-7f19-4130-abae-610a8f5dddca"), eTargetID::MatthieuMendola},
	{ZRepositoryID("ee3f55b8-12f8-4245-8ef2-3022b4f6f120"), eTargetID::JordanCross},
	{ZRepositoryID("f65fff84-6cad-4a11-9a0a-b89430c03397"), eTargetID::KenMorgan},
	{ZRepositoryID("010e451b-99de-4a73-a6df-520158636654"), eTargetID::OybekNabazov},
	{ZRepositoryID("893ecd0c-9a13-42a6-b3f5-72c6059d4b16"), eTargetID::SisterYulduz},
	{ZRepositoryID("5b54d9fb-fa85-4302-a8d5-c5c5e97344c4"), eTargetID::SeanRose},
	{ZRepositoryID("963c2774-cb9a-4b0c-ab69-210b2405383b"), eTargetID::PenelopeGraves},
	{ZRepositoryID("1a8a827f-932e-49c0-a1b3-e3201795ae19"), eTargetID::EzraBerg},
	{ZRepositoryID("d94f3e83-36e3-453c-8d4b-28c93229826a"), eTargetID::MayaParvati},
	{ZRepositoryID("5651198f-9ef7-4f3c-908b-a570f1cd64e2"), eTargetID::ErichSoders},
	{ZRepositoryID("9bebb40a-3746-4ba2-8bfc-a1fcabaec72c"), eTargetID::YukiYamazaki},
	{ZRepositoryID("3798fcf3-4e33-40db-a8a2-c160a3ec55bf"), eTargetID::OwenCage},
	{ZRepositoryID("01822ba2-7b3b-4bbd-a9f3-cf8006ba945a"), eTargetID::KlausLiebleid},
	{ZRepositoryID("5087ab4a-586c-4967-967c-487cc2d17c92"), eTargetID::DmitriFedorov},
	{ZRepositoryID("9e85c891-9eb7-4f3c-8115-896bf54d979b"), eTargetID::AlmaReynard},
	{ZRepositoryID("c0ab162c-1502-40d5-801f-c5471289d6b7"), eTargetID::SierraKnox}, // af77ead8-72d4-461c-adb8-dd55146d029f car? 
	{ZRepositoryID("ee454990-0c4b-49e5-9572-a67887325283"), eTargetID::RobertKnox},
	{ZRepositoryID("466b652d-cea0-47eb-823a-2aba9f67b5ad"), eTargetID::AjitKrish},
	{ZRepositoryID("00df867e-f27f-4904-8bc7-9504443ccb5a"), eTargetID::RicoDelgado},
	{ZRepositoryID("b87b242e-4ef4-42d8-94ed-17cbfc9009bf"), eTargetID::JorgeFranco},
	{ZRepositoryID("db21a429-add2-46fa-8176-540f846d89e0"), eTargetID::AndreaMartinez},
	{ZRepositoryID("1e8bbf5a-473e-4b00-b58a-4706f13e497b"), eTargetID::BlairReddington},
	{ZRepositoryID("c7c9e213-16f9-4215-bf07-dd8f801ce3e0"), eTargetID::WazirKale},
	{ZRepositoryID("076f23cc-09d8-423f-b890-74020f53b1d6"), eTargetID::VanyaShah},
	{ZRepositoryID("78f98c70-b7be-4578-9b6a-1c96a3e1ff1a"), eTargetID::DawoodRangan},
	{ZRepositoryID("07ccfa5d-6dd3-4d2b-9f79-75b300524857"), eTargetID::BasilCarnaby},
	{ZRepositoryID("672a7a52-a08a-45cd-a061-ced6a7b8d8c4"), eTargetID::Janus},
	{ZRepositoryID("b8f0bf6c-4826-4de2-a785-2d139967e09c"), eTargetID::NolanCassidy},
	{ZRepositoryID("3cf8ef68-e6f3-466a-9299-de50e9f0a9bb"), eTargetID::GalenVholes},
	{ZRepositoryID("7eb39f2d-1030-44d2-be82-6df608085ec0"), eTargetID::ZoeWashington},
	{ZRepositoryID("67f39ab8-c25f-48c3-84be-0ec495a553ec"), eTargetID::SophiaWashington},
	{ZRepositoryID("ad93e268-3d6e-4aba-bec0-607cb5451ac7"), eTargetID::AthenaSavalas},
	{ZRepositoryID("7504b78e-e766-42fe-930c-c5640f5f507b"), eTargetID::TysonWilliams},
	{ZRepositoryID("0afcc59e-6d6e-433f-8404-7699df872c9d"), eTargetID::StevenBradley},
	{ZRepositoryID("5bc06fb1-bfb3-48ef-94ae-6f18c16c1eee"), eTargetID::LjudmilaVetrova},
	{ZRepositoryID("bd0689d6-07b4-4757-b8ee-cac19f1c9e16"), eTargetID::CarlIngram},
	{ZRepositoryID("9571d196-8d67-4d94-8dad-6e2d970d7a91"), eTargetID::MarcusStuyvesant},
	{ZRepositoryID("080efb03-a66a-401e-b6df-4eac496e9e2d"), eTargetID::AlexaCarlisle},
	{ZRepositoryID("967abcf9-2672-4e81-8fef-211aaa366747"), eTargetID::Hush},
	{ZRepositoryID("a7fd7a4f-2bee-4787-bc60-90f9dd64233b"), eTargetID::ImogenRoyce},
	{ZRepositoryID("57907f04-329e-4faf-b753-7e95d5c2e085"), eTargetID::DonArchibaldYates},
	{ZRepositoryID("651ceb9a-117f-4f8d-89dd-9b6bd2a38b5a"), eTargetID::TamaraVidal},
	{ZRepositoryID("f133d999-a93b-450a-b236-a7ed404a38e2"), eTargetID::ArthurEdwards},
	{ZRepositoryID("4f80ca40-a8f3-4a5e-9add-4c74d3bb5bcc"), eTargetID::NoelCrest},
	{ZRepositoryID("666521d2-1efe-4d0a-b7f7-2afeb08262b6"), eTargetID::SinhiAkkaVenthan},

	{ZRepositoryID("05966483-af64-47a6-9e3b-e639fe23206d"), eTargetID::AgentChamberlin},
	{ZRepositoryID("107c35d7-7300-417c-832a-4f36cd3071b9"), eTargetID::AgentThames},
	{ZRepositoryID("28cb7e91-bf9c-46ee-a371-1bd1448f1994"), eTargetID::AgentThames},
	{ZRepositoryID("1305c2e4-6394-4cfa-b873-22adbd0c9702"), eTargetID::AgentChamberlin},
	{ZRepositoryID("252428ca-3f8e-4477-b2b9-58f18cff3e44"), eTargetID::AgentTremaine},
	{ZRepositoryID("2ab07903-e958-4af6-b01c-b62058745ce1"), eTargetID::AgentLowenthal},
	{ZRepositoryID("5fd9b187-0745-492a-88a0-afcc51f90c46"), eTargetID::AgentMontgomery},
	{ZRepositoryID("633398ac-c4b4-4441-852d-ae6460172025"), eTargetID::AgentGreen},
	{ZRepositoryID("88fd409e-6570-4a42-94f7-e5d362a8d960"), eTargetID::AgentThames},
	{ZRepositoryID("8b29da09-461f-44d7-9042-d4fde829b9f2"), eTargetID::AgentMontgomery},
	{ZRepositoryID("8b7c3ec6-c072-4a21-a323-0f8751028052"), eTargetID::AgentGreen},
	{ZRepositoryID("922deccd-7fb4-45d9-ae3d-2cf11915c403"), eTargetID::AgentSwan},
	{ZRepositoryID("abd1c0e7-e406-43bd-9185-419029c5bf3d"), eTargetID::AgentBanner},
	{ZRepositoryID("b8e7e65b-587e-471b-894d-282cda6614d4"), eTargetID::AgentDavenport},
	{ZRepositoryID("daf89737-dd98-4850-a218-2435e99a378c"), eTargetID::AgentSwan},
	{ZRepositoryID("eb024a5e-9580-49dc-a519-bb92c886f3b1"), eTargetID::AgentRhodes},
	{ZRepositoryID("f83376a4-6e56-4f2a-8122-151b272108fd"), eTargetID::AgentPrice},
};
...
std::vector<Keyword> Keyword::keywords = {
	...
	// Map Kill Method - Silvio Caruso
	{ "ShootThroughTelescope", eMapKillMethod::Silvio_ShootThroughTelescope },
	{ "ShootSilvioThroughTheTelescope", eMapKillMethod::Silvio_ShootThroughTelescope, "ShootThroughTelescope" },
	{ "ShootThroughTheTelescope", eMapKillMethod::Silvio_ShootThroughTelescope, "ShootThroughTelescope" },
	{ "Telescope", eMapKillMethod::Silvio_ShootThroughTelescope, "ShootThroughTelescope" },
	...
	{ "AthenaAward", eMapKillMethod::Athena_Award, "AthenaSavalasAward" },
	{ "Award", eMapKillMethod::Athena_Award, "AthenaSavalasAward" },
	// Map Kill Method - Steven Bradley
	{ "BombWaterScooter", eMapKillMethod::Steven_BombWaterScooter },
	{ "BombJetski", eMapKillMethod::Steven_BombWaterScooter, "BombWaterScooter" },
	{ "Jetski", eMapKillMethod::Steven_BombWaterScooter, "BombWaterScooter" },
	{ "WaterScooter", eMapKillMethod::Steven_BombWaterScooter, "BombWaterScooter" },
	{ "Scooter", eMapKillMethod::Steven_BombWaterScooter, "BombWaterScooter" },
	{ "ExplosiveOnJetski", eMapKillMethod::Steven_BombWaterScooter, "BombWaterScooter" },
	{ "ExplosiveOnWaterScooter", eMapKillMethod::Steven_BombWaterScooter, "BombWaterScooter" },
