...
const std::vector<DisguiseKeywords> disguiseKeywords = {
	...
	DisguiseKeywords{{eMission::WHITTLETON_ANOTHERLIFE, eMission::WHITTLETON_ABITTERPILL}, {
		...
		{"spencerthehammergreen", "Spencer \"The Hammer\" Green"},
		...
		{"hammergreen", "Spencer \"The Hammer\" Green"},
	}},
...
const std::unordered_map<std::string, std::string> methodKeywords = {
	...
	{"antiquecarvedknife", "Antique Curved Knife"},
	{"antiquecarveknife", "Antique Curved Knife"},
	{"antiqueknife", "Antique Curved Knife"},
	{"curvedknife", "Antique Curved Knife"},
	{"curveknife", "Antique Curved Knife"},
	{"carvedknife", "Antique Curved Knife"},
	{"carveknife", "Antique Curved Knife"},
	...
	{"shootcar", "Shoot the Car"},
	{"shootthecar", "Shoot the Car"},
	{"carshot", "Shoot the Car"},
	{"snipecar", "Shoot the Car"},
	{"carsnipe", "Shoot the Car"},
	{"destroycarviaexplosive", "Bomb the Car"},
	{"destroythecar", "Bomb the Car"},
	{"destroycar", "Bomb the Car"},
	{"carbomb", "Bomb the Car"},
	{"bombcar", "Bomb the Car"},
	{"bomboncar", "Bomb the Car"},
	{"bombonthecar", "Bomb the Car"},
	{"explodecar", "Bomb the Car"},
	{"carexplode", "Bomb the Car"},
	{"carexplosion", "Bomb the Car"},
	{"carexplosive", "Bomb the Car"},
	{"explosivecar", "Bomb the Car"},
	{"explosiveoncar", "Bomb the Car"},
	{"viaexplosive", "Bomb the Car"},
	{"starfish", "Starfish"},
	{"tanto", "Tanto"},
