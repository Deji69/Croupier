...
std::unordered_map<std::string, std::string> keywordKeywords = {
	{"bg", "bodyguard"},
	{"bgd", "bodyguard"},
	{"bdgd", "bodyguard"},
	{"bdygd", "bodyguard"},
...
std::vector<DisguiseKeywords> disguiseKeywords = {
...
std::unordered_map<std::string, std::string> methodKeywords = {
...
std::unordered_map<std::string, eKillComplication> complicationKeywords = {
...
std::unordered_map<std::string, eKillType> killTypeKeywords = {
	{"loud", eKillType::Loud},
	{"ld", eKillType::Loud},
